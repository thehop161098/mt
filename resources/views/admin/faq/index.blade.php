...
<faq-listing :data="{{ $data->toJson() }}" :url="'{{ url('admin/faqs') }}'" inline-template>
        ...
        <div class="col">
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0" href="{{ url('admin/faqs/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; Add</a>
                </div>
                <div class="card-body" v-cloak>
                    <div class="card-block">
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'sort'">sort</th>
                        ...
                        <div class="no-items-found" v-if="!collection.length > 0">
                            ...
                            <a class="btn btn-primary btn-spinner" href="{{ url('admin/faqs/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; Add</a>
                        </div>
                    </div>
                </div>
            </div>
