...
class WithdrawSuccessMail extends Mailable implements ShouldQueue
{
    ...
    public function __construct($data)
    {
        ...
        $email = $emailRepository->find(config('constants.email.withdraw_success'));
        $subject = 'Withdrawal Successful';
        $content = '<p>Withdrawal Successful</p>';
        if ($email) {
