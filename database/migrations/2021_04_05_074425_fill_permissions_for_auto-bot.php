...
class FillPermissionsForAutoBot extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAutoBot constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.auto-bot',
            'admin.auto-bot.index',
            'admin.auto-bot.create',
            'admin.auto-bot.show',
            'admin.auto-bot.edit',
            'admin.auto-bot.delete',
            'admin.auto-bot.bulk-delete',
        ]);
