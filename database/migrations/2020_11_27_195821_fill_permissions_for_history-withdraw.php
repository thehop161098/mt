...
class FillPermissionsForHistoryWithdraw extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForHistoryWithdraw constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.history-withdraw.index',
            'admin.history-withdraw.create',
            'admin.history-withdraw.show',
            'admin.history-withdraw.edit',
            'admin.history-withdraw.delete',
            'admin.history-withdraw.bulk-delete',
        ]);
