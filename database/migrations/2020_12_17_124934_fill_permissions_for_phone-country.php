...
class FillPermissionsForPhoneCountry extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPhoneCountry constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.phone-country',
            'admin.phone-country.index',
            'admin.phone-country.create',
            'admin.phone-country.show',
            'admin.phone-country.edit',
            'admin.phone-country.delete',
            'admin.phone-country.bulk-delete',
        ]);
