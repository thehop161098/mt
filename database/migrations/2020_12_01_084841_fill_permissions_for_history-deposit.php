...
class FillPermissionsForHistoryDeposit extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForHistoryDeposit constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.history-deposit.index',
            'admin.history-deposit.create',
            'admin.history-deposit.show',
            'admin.history-deposit.edit',
            'admin.history-deposit.delete',
            'admin.history-deposit.bulk-delete',
        ]);
