...
class FillPermissionsForSettingRefund extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSettingRefund constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.setting-refund',
            'admin.setting-refund.index',
            'admin.setting-refund.create',
            'admin.setting-refund.show',
            'admin.setting-refund.edit',
            'admin.setting-refund.delete',
            'admin.setting-refund.bulk-delete',
        ]);
