...
class FillPermissionsForHistoryBot extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForHistoryBot constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.history-bot',
            'admin.history-bot.index',
            'admin.history-bot.create',
            'admin.history-bot.show',
            'admin.history-bot.edit',
            'admin.history-bot.delete',
            'admin.history-bot.bulk-delete',
        ]);
