...
class FillPermissionsForWheelSetting extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForWheelSetting constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.wheel-setting',
            'admin.wheel-setting.index',
            'admin.wheel-setting.create',
            'admin.wheel-setting.show',
            'admin.wheel-setting.edit',
            'admin.wheel-setting.delete',
            'admin.wheel-setting.bulk-delete',
        ]);
