...
class FillPermissionsForHistoryRefund extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForHistoryRefund constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.history-refund.index',
            'admin.history-refund.create',
            'admin.history-refund.show',
            'admin.history-refund.edit',
            'admin.history-refund.delete',
            'admin.history-refund.bulk-delete',
        ]);
